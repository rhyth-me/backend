...
func main() {
	...
	jsonDir := flag.String("json-dir", "interfaces/mock_jsons", "mock jsons directory")
	flag.Parse()
	...
	e.Use(func(next echo.HandlerFunc) echo.HandlerFunc {
		serverName := fmt.Sprintf("api_gen-mock_server/%s", "1.8.0")
	...
	interfaces.MockBootstrap(e, os.Stderr, jsonDirPath)
